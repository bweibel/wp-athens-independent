...
= 1.5.2 - 8/9/25 =
* Fix issue with desktop dropdown toggle

= 1.5.1 - 8/9/25 =
* Fix issue with mobile menu dropdown toggle
* Remove header selector on navigation styles in case user is not using the Header template part

= 1.5.0 - 7/29/25 =
* Add menu card and mobile menu patterns
* Improve markup on header and footer patterns
* Improve mobile menu overlay styles
