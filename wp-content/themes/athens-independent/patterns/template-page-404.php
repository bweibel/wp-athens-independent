...
<h1 class="has-text-align-center"><?php esc_html_e( 'Page Not Found', 'athens-independent' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"secondary"} -->
<p class="has-text-align-center has-secondary-color has-text-color"><?php esc_html_e( 'Unfortunately, the page you are looking for no longer exists, or has been moved. Please try searching for your content below.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group has-tertiary-background-color has-background" style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:search {"showLabel":false,"placeholder":"<?php esc_attr_e( 'Search', 'athens-independent' ); ?>","widthUnit":"px","buttonText":"<?php esc_attr_e( 'Search', 'athens-independent' ); ?>"} /--></div>
<!-- /wp:group --></main>
<!-- /wp:group -->
