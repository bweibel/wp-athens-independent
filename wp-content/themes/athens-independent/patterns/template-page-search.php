 ...
 * Slug: athens-independent/template-page-search
...
<!-- wp:search {"label":"","placeholder":"<?php esc_attr_e( 'Search site...', 'athens-independent' ); ?>","buttonText":"<?php esc_attr_e( 'Search', 'athens-independent' ); ?>"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:query-no-results -->
<!-- wp:paragraph {"placeholder":"<?php esc_attr_e( 'Add text or blocks that will display when a query returns no results.', 'athens-independent' ); ?>","style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
<p style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><?php esc_html_e( 'Sorry, nothing was found for that search term.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
