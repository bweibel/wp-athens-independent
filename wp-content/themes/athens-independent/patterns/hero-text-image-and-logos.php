 ...
 * Slug: athens-independent/hero-text-image-and-logos
 * Description:
...
<p class="has-text-align-center has-primary-color has-text-color" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Welcome to Athens Independent', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:heading {"textAlign":"center","fontSize":"x-large"} -->
<h2 class="wp-block-heading has-text-align-center has-x-large-font-size"><?php esc_html_e( 'Design faster and publish sooner with Athens Independent', 'athens-independent' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","textColor":"secondary"} -->
<p class="has-text-align-center has-secondary-color has-text-color"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Athens Independent block theme. No coding skills required.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Free Download', 'athens-independent' ); ?></a></div>
<!-- /wp:button -->
<!-- wp:button {"className":"is-style-button-light","borderColor":"tertiary"} -->
<div class="wp-block-button is-style-button-light"><a class="wp-block-button__link has-border-color has-tertiary-border-color wp-element-button"><?php esc_html_e( 'Athens Independent', 'athens-independent' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></section>
<!-- /wp:group -->
...
<div class="wp-block-cover alignwide is-light is-style-blur-image is-style-default" style="border-radius:5px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><span aria-hidden="true" class="wp-block-cover__background has-main-background-color has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-3024" alt="<?php esc_attr_e( 'Desktop preview', 'athens-independent' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/desktop.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"<?php esc_attr_e( 'Write title…', 'athens-independent' ); ?>"} -->
