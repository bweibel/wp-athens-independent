...
/**
 * Title: Menu Panel 3
 * Slug: athens-independent/menu-panel-3
...
<p><strong><?php esc_html_e( 'Quick Resources', 'athens-independent' ); ?></strong></p>
<!-- /wp:paragraph -->
...
<p><?php esc_html_e( 'Projects', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Templates', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Team', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Integrations', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'FAQs', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":75,"className":"is-style-secondary-button"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-75 is-style-secondary-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Browse All', 'athens-independent' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="border-radius:10px;padding-top:var(--wp--preset--spacing--medium);padding-right:0;padding-bottom:var(--wp--preset--spacing--medium);padding-left:0"><!-- wp:paragraph -->
<p><strong><?php esc_html_e( 'Learn Our Product', 'athens-independent' ); ?></strong></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"metadata":{"name":"Links"},"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php esc_html_e( 'Documentation', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Playground', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Dashboard', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Community', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Enterprise', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Marketplace', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-base-font-size"><strong><?php esc_html_e( 'Success Stories', 'athens-independent' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'See how companies like yours increased productivity by 40% overnight.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"className":"athensindie-no-shrink is-style-button-light"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 athensindie-no-shrink is-style-button-light"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Start Free Trial', 'athens-independent' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
