...
/**
 * Title: Mobile Menu 3
 * Slug: athens-independent/mobile-menu-3
 * Description: 
...
<p class="has-medium-font-size"><strong><?php esc_html_e( 'Margo Middleton', 'athens-independent' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary"} -->
<p class="has-secondary-color has-text-color has-link-color"><?php esc_html_e( 'Director of AI', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p><a href="#"><?php esc_html_e( 'Pre-designed Patterns', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph -->
...
<p class="has-secondary-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Check out my new podcast, VectorAI.', 'athens-independent' ); ?><a href="#"><?php esc_html_e( 'Learn more', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
