...
/**
 * Title: Archive Page
 * Slug: athens-independent/template-page-archive
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:pattern {"slug":"athens-independent/post-loop-grid-default"} /--></main>
<!-- /wp:group -->
