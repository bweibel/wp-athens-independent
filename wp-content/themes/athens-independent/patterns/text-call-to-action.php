 ...
 * Slug: athens-independent/text-call-to-action
...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'No code? No problem.', 'athens-independent' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'Build your blazing fast website with the power of the WordPress Site Editor and beautiful, pre-made designs from Athens Independent. No coding skills required.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
