...
<!-- wp:co-authors-plus/coauthors {"prefix":"","separator":"","lastSeparator":""} -->
<div class="wp-block-co-authors-plus-coauthors"><!-- wp:columns {"verticalAlignment":"center"} -->
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"100px"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:100px"><!-- wp:co-authors-plus/avatar {"size":96,"isLink":true,"style":{"border":{"radius":{"topLeft":"100%","topRight":"100%","bottomLeft":"100%","bottomRight":"100%"}}}} /--></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center"} -->
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:co-authors-plus/name {"isLink":true,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}}} /-->

<!-- wp:co-authors-plus/description /--></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
