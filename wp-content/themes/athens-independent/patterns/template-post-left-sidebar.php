 ...
 * Slug: athens-independent/template-post-left-sidebar
...
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"athens-independent"} /--></div>
<!-- /wp:column -->
...
<div class="wp-block-group has-secondary-color has-text-color has-link-color has-small-font-size" style="font-style:normal;font-weight:500"><!-- wp:co-authors-plus/coauthors -->
...
<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"width":"33.33%","className":"athensindie-hide-on-mobile"} -->
<div class="wp-block-column athensindie-hide-on-mobile" style="flex-basis:33.33%"></div>
<!-- /wp:column -->
