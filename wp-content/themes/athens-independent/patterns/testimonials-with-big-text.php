 ...
 * Slug: athens-independent/testimonials-with-big-text
 * Description: 
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Testimonials', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Easily create beautiful, blazing-fast websites with the new WordPress Site Editor.', 'athens-independent' ); ?><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-color"><?php esc_html_e( 'No coding skills required.', 'athens-independent' ); ?></mark></h2>
<!-- /wp:heading -->
...
<p><?php esc_html_e( 'I love using WordPress but traditionally it has been hard to design in. Not any more! Now, I can quickly build full page designs with beautiful patterns!', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<p style="font-style:normal;font-weight:500"><?php esc_html_e( 'Alex Glacier', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group is-style-default has-border-color has-border-light-border-color has-base-background-color has-background" style="border-width:1px;border-radius:5px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:paragraph -->
<p><?php esc_html_e( 'I create a lot of landing pages, and the Site Editor and Athens Independent have been a game changer for this. Choose a layout, add my content, hit publish.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
<p style="font-style:normal;font-weight:500"><?php esc_html_e( 'Maryann Alpine', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
