...
/**
 * Title: Footer
 * Slug: athens-independent/footer-dark
 * Description: 
 * Categories: footer
 * Keywords: 
 * Viewport Width: 1500
...
<p class="has-main-accent-color has-text-color has-small-font-size"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Athens Independent block theme. No coding skills required. Download for free today!', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-small-font-size"><?php esc_html_e( '© 2025 · Powered by WordPress and', 'athens-independent' ); ?><a href="https://athensindependent.com"><?php esc_html_e( 'Athens Independent', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph -->
