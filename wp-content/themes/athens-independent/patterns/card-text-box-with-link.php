...
/**
 * Title: Text Box Card
 * Slug: athens-independent/text-box-with-link-card
 * Description: 
...
<p class="has-medium-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e( 'Post Page', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"secondary"} -->
<p class="has-secondary-color has-text-color"><?php esc_html_e( 'Add your splash of colors, pick your header, choose your favorite font — all with a few quick clicks. No coding skills required.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-primary-color has-text-color has-link-color" style="text-decoration:underline"><?php esc_html_e( 'Read More', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
