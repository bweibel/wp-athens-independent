...
/**
 * Title: Mobile Menu 4
 * Slug: athens-independent/mobile-menu-4
 * Description: 
...
<p class="has-medium-font-size"><strong><?php esc_html_e( 'Prism AI', 'athens-independent' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|main-accent"}}}},"textColor":"main-accent"} -->
<p class="has-main-accent-color has-text-color has-link-color"><?php esc_html_e( 'Design solutions that scale', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p style="text-decoration:none"><a href="#"><?php esc_html_e( 'Pre-designed Patterns', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Built for the Future', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Easy to Extend', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Developer Friendly', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Publish Faster', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons {"style":{"layout":{"selfStretch":"fit","flexSize":null}}} -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"fontSize":"x-small"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-x-small-font-size has-custom-font-size wp-element-button"><?php esc_html_e( 'Get Started Today', 'athens-independent' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-main-accent-color has-text-color has-link-color has-small-font-size" style="text-transform:uppercase"><?php esc_html_e( 'Contact Us', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-base-font-size"><?php esc_html_e( 'hello@example.com', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'support@example.com', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p class="has-main-accent-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'We\'re hiring! Join our growing team today.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
