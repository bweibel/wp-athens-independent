 ...
 * Slug: athens-independent/footer-light-centered
 * Description: 
 * Categories: footer
 * Keywords: 
 * Viewport Width: 1500
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Twitter', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-small-font-size"><?php esc_html_e( '© 2025 · Powered by WordPress and', 'athens-independent' ); ?><a href="https://athensindependent.com"><?php esc_html_e( 'Athens Independent', 'athens-independent' ); ?></a></p>
<!-- /wp:paragraph -->
