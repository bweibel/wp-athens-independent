 ...
 * Slug: athens-independent/testimonial-highlight
 * Description: 
...
<h2 class="wp-block-heading has-base-color has-text-color"><?php esc_html_e( 'I\'m super impressed with how powerful the WordPress Site Editor is. I can design my site so quickly with patterns!', 'athens-independent' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-base-color has-text-color"><strong><?php esc_html_e( 'Maryann Alpine', 'athens-independent' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"main-accent","fontSize":"small"} -->
<p class="has-main-accent-color has-text-color has-small-font-size"><?php esc_html_e( 'Product Designer', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
