 ...
 * Slug: athens-independent/lead-magnet-card
 * Description: A call-to-action box to offer a free download or sign up user to an email list.
 * Categories: athens-independent/call-to-action, athens-independent/card
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Download Athens Independent', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e( 'Start using the powerful new WordPress editor with Athens Independent', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'Start creating beautiful, fully-customizable websites with the new WordPress Site Editor and the Athens Independent block theme.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100 lemonsqueezy-button"><a class="wp-block-button__link wp-element-button" href="https://athensindependent.com"><?php esc_html_e( 'Download Athens Independent for free!', 'athens-independent' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
