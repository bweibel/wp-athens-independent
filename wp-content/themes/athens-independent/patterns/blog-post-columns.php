 ...
 * Slug: athens-independent/blog-post-columns
 * Description:
...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Latest and Greatest', 'athens-independent' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Read our latest blog articles', 'athens-independent' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'Learn the latest and greatest in WordPress site building. We\'re offering tutorials, tips and tricks, and video walkthroughs on our blog.', 'athens-independent' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:pattern {"slug":"athens-independent/blog-post-card"} /-->
